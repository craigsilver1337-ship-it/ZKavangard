    ...
    <div className="glass-strong rounded-3xl p-6 border border-gray-200 dark:border-gray-800 shadow-ios">
      ...
      <div className="space-y-3">
        {steps.map((step, index) => {
          ...
          return (
            <div key={index} className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h4 className="text-sm font-semibold text-black dark:text-white">{step.title}</h4>
                </div>
                <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">{step.description}</p>
                <code className="text-xs text-primary-500 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded">{step.example}</code>
              </div>
            </div>
          );
        })}
