      ...
      <div className="max-w-[980px] mx-auto px-6 lg:px-8">
        ...
        <div className="pt-12 lg:pt-16 pb-8 lg:pb-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-20">
            <div>
              <h3 className="text-[12px] font-semibold text-[#1d1d1f] dark:text-white mb-4 tracking-wide">PRODUCT</h3>
            ...
            <div>
              <h3 className="text-[12px] font-semibold text-[#1d1d1f] dark:text-white mb-4 tracking-wide">PLATFORM</h3>
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-[14px] text-[#424245] dark:text-gray-400 hover:text-[#007AFF] transition-colors leading-relaxed">Whitepaper</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-[14px] text-[#424245] dark:text-gray-400 hover:text-[#007AFF] transition-colors leading-relaxed">Support</a></li>
                <li><a href="#" className="text-[14px] text-[#424245] dark:text-gray-400 hover:text-[#007AFF] transition-colors leading-relaxed">Community</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/privacy" className="text-[14px] text-[#424245] dark:text-gray-400 hover:text-[#007AFF] transition-colors leading-relaxed">Privacy Policy</Link></li>
                <li><Link href="/terms" className="text-[14px] text-[#424245] dark:text-gray-400 hover:text-[#007AFF] transition-colors leading-relaxed">Terms of Service</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[#d2d2d7] py-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="text-[12px] text-[#86868b] dark:text-gray-500 leading-relaxed">
